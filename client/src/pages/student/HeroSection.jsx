...
const HeroSection = () => {
  return (
    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <Input
            type="text"
            className="grow border-none focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-gray-400 dark:placeholder-gray-500 placeholder-gray-100 "
